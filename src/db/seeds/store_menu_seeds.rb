...
Menu.where(id: 15).first_or_create!(name: 'ダブルメインコース', skill_id: 1, fee: 12_000, service_minutes: 120, start_at: '2019-01-01', menu_category_id: 6)
Menu.where(id: 16).first_or_create!(name: 'シンプルプラン', skill_id: 1, fee: 30_000, service_minutes: 0, start_at: '2019-01-01', menu_category_id: 6)
Menu.where(id: 17).first_or_create!(name: 'エレガントプラン', skill_id: 1, fee: 60_000, service_minutes: 0, start_at: '2019-01-01', menu_category_id: 6)
Menu.where(id: 18).first_or_create!(name: 'デラックスプラン', skill_id: 1, fee: 90_000, service_minutes: 0, start_at: '2019-01-01', menu_category_id: 6)
Menu.where(id: 19).first_or_create!(name: 'ラグジュアリープラン', skill_id: 1, fee: 126_000, service_minutes: 0, start_at: '2019-01-01', menu_category_id: 6)
